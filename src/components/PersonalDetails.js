  import { Box, FormControlLabel, FormLabel, TextField, Typography} from '@mui/material'
...
function PersonalDetails() {
    ...
    const tamilNaduDistricts = [
      ...
      style={{ background: "rgb(0,0,0,0.8)" }}>{item}</MenuItem>
    ...
    <Typography variant='h5'  >Personal Details:</Typography><br/>
        ...
        <Stack spacing={3} direction='column' alignItems='flex-start'>
            ...
            <TextField required type='text' label="Career" select  variant='standard'    name='career' 
                ...
                <MenuItem value='student' style={{backgroundColor:'rgb(0,0,0,0.8)' }} >Student</MenuItem>
                <MenuItem value='govt job' style={{backgroundColor:'rgb(0,0,0,0.8)' }} >Government Job</MenuItem>
                <MenuItem value='private job' style={{backgroundColor:'rgb(0,0,0,0.8)' }}>Private Job</MenuItem>
                <MenuItem value='self employed' style={{backgroundColor:'rgb(0,0,0,0.8)' }}>Self employed</MenuItem>
            </TextField>
